...
docker-compose --env-file ../.versions_env exec exareme2_mipdb mipdb init
docker-compose --env-file ../.versions_env exec exareme2_mipdb mipdb load-folder /opt/data 
